...
export function getResponseMsg(
 resp: AI_MODEL_RESPONSE,
 structure: "ollama" | "openrouter",
) {
 return structure === "ollama"
  ? _getOllamaResponseMsg(resp)
  : _getOpenRouterResponseMsg(resp);
}
