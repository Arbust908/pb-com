...
<template>
  <div class="relative isolate overflow-hidden bg-white px-6 py-24 lg:overflow-visible lg:px-0 sm:py-32">
    <div class="absolute inset-0 overflow-hidden -z-10">
      <svg class="[mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] absolute left-[max(50%,25rem)] top-0 h-[64rem] w-[128rem] stroke-gray-200 -translate-x-1/2" aria-hidden="true">
        <defs>
    ...
    <div class="grid grid-cols-1 mx-auto max-w-2xl gap-x-8 gap-y-16 lg:grid-cols-2 lg:mx-0 lg:max-w-none lg:items-start lg:gap-y-10">
      <div class="lg:grid lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:grid-cols-2 lg:mx-auto lg:max-w-7xl lg:w-full lg:gap-x-8 lg:px-8">
        <div class="lg:pr-4">
          <div class="lg:max-w-lg">
            <p class="text-base text-indigo-600 font-semibold leading-7">
              Deploy faster
            </p>
            <h1 class="mt-2 text-3xl text-gray-900 font-bold tracking-tight sm:text-4xl">
              A better workflow
            </h1>
      ...
      <div class="p-12 lg:sticky lg:top-4 lg:row-span-2 lg:col-start-2 lg:row-start-1 -ml-12 -mt-12 lg:overflow-hidden">
        <img class="max-w-none w-[48rem] rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]" src="https://tailwindui.com/img/component-images/dark-project-app-screenshot.png" alt="">
      </div>
      <div class="lg:grid lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:grid-cols-2 lg:mx-auto lg:max-w-7xl lg:w-full lg:gap-x-8 lg:px-8">
        <div class="lg:pr-4">
          <div class="max-w-xl text-base text-gray-700 leading-7 lg:max-w-lg">
            <p>Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id. Id dolor praesent donec est. Odio penatibus risus viverra tellus varius sit neque erat velit. Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id.</p>
            <ul role="list" class="mt-8 text-gray-600 space-y-8">
              <li class="flex gap-x-3">
                <CloudArrowUpIcon class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span><strong class="text-gray-900 font-semibold">Push to deploy.</strong> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</span>
              </li>
              <li class="flex gap-x-3">
                <LockClosedIcon class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span><strong class="text-gray-900 font-semibold">SSL certificates.</strong> Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span>
              </li>
              <li class="flex gap-x-3">
                <ServerIcon class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                <span><strong class="text-gray-900 font-semibold">Database backups.</strong> Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</span>
              </li>
            </ul>
            <p class="mt-8">
            ...
            <h2 class="mt-16 text-2xl text-gray-900 font-bold tracking-tight">
