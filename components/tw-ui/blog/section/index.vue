          ...
          <article v-for="post in posts" :key="post.id" class="relative isolate flex flex-col gap-8 lg:flex-row">
            ...
            <div>
              <div class="flex items-center gap-x-4 text-xs">
                ...
                <a :href="post.category.href" class="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 text-gray-600 font-medium hover:bg-gray-100">{{ post.category.title }}</a>
              </div>
              <div class="group relative max-w-xl">
                <h3 class="mt-3 text-lg text-gray-900 font-semibold leading-6 group-hover:text-gray-600">
                  <a :href="post.href">
                    <span class="absolute inset-0" />
                    {{ post.title }}
                  </a>
                </h3>
                <p class="mt-5 text-sm text-gray-600 leading-6">
                  {{ post.description }}
                </p>
              </div>
