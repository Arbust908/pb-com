...
<template>
  <div class="fixed inset-x-0 bottom-0 flex flex-col justify-between gap-x-8 gap-y-4 bg-white p-6 ring-1 ring-gray-900/10 md:flex-row md:items-center lg:px-8">
    ...
    <div class="flex flex-none items-center gap-x-5">
      <button type="button" class="rounded-md bg-gray-900 px-3 py-2 text-sm text-white font-semibold shadow-sm hover:bg-gray-700 focus-visible:outline-2 focus-visible:outline-gray-900 focus-visible:outline-offset-2 focus-visible:outline">
        Accept all
      </button>
...
<template>
  <div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
    ...
    <p class="text-sm leading-6 text-gray-900">
      GeneriCon 2023 is on June 7 – 9 in Denver. <a href="#" class="whitespace-nowrap font-semibold">Get your ticket&nbsp;<span aria-hidden="true">&rarr;</span></a>
    </p>
    <div class="flex flex-1 justify-end">
      <button type="button" class="-m-3 p-3 focus-visible:outline-offset-[-4px]">
        <span class="sr-only">Dismiss</span>
