    ...
    <div class="space-y-5">
      <div class="relative flex items-start">
        <div class="h-6 flex items-center">
          <input id="comments" aria-describedby="comments-description" name="comments" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-600">
        </div>
        <div class="ml-3 text-sm leading-6">
          <label for="comments" class="text-gray-900 font-medium">Comments</label>
      ...
      <div class="relative flex items-start">
        <div class="h-6 flex items-center">
          <input id="candidates" aria-describedby="candidates-description" name="candidates" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-600">
        </div>
        <div class="ml-3 text-sm leading-6">
          <label for="candidates" class="text-gray-900 font-medium">Candidates</label>
      ...
      <div class="relative flex items-start">
        <div class="h-6 flex items-center">
          <input id="offers" aria-describedby="offers-description" name="offers" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-600">
        </div>
        <div class="ml-3 text-sm leading-6">
          <label for="offers" class="text-gray-900 font-medium">Offers</label>
