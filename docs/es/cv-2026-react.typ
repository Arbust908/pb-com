...
#job(
  ...
  description: [
    ...
    - Construí integraciones de referidos, recompensas y CMS para SimplyCodes. En Dealspotr y Knoji aislé reglas de negocio existentes para modificar productos legacy sin reescrituras amplias.

    - En la etapa final amplié mi trabajo al backend con Node.js y TypeScript, desarrollando funcionalidades de punta a punta con Docker, Redis, PostgreSQL y CI/CD hasta el despliegue.
  ],
)
